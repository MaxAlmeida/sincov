...
class BudgetProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create budget_product" do
    assert_difference('BudgetProduct.count') do
      post budget_products_url, params: { budget_product: { budget: @budget_product.budget, integer: @budget_product.integer, product_id: @budget_product.product_id, quantity: @budget_product.quantity } }
    end
  ...
  test "should update budget_product" do
    patch budget_product_url(@budget_product), params: { budget_product: { budget: @budget_product.budget, integer: @budget_product.integer, product_id: @budget_product.product_id, quantity: @budget_product.quantity } }
